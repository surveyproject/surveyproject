...
namespace Votations.NSurvey.WebControls.UI
{
    ...
    {
        /// <summary>
        /// Builds a horizontal panel containing all the answer items
        /// </summary>
        /// <returns>An horizontal Panel with all the answer items</returns>
        ...
        /// <summary>
        /// Builds a vertical Panel containing all the answer items
        /// </summary>
