namespace Votations.NSurvey.Resources
{
    ...
    /// <summary>
    /// Css XML manager to access the survey xml CSS file.
    /// </summary>
    public class CssXmlManager
    {
        /// <summary>
        ...
        public static Hashtable LoadResources(string language)
        {
            ...
            string path = HttpContext.Current.Server.MapPath(GlobalConfig.CssXmlFilePath + "SurveyBox.xml");
            string key = "NSurvey:Css:" + language;
