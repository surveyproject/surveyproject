namespace Votations.NSurvey.Resources
{
    ...
    /// <summary>
    /// Manager to handle LanguageCodes used in Multilanguage and Libraries
    /// </summary>
    public class LanguageCodesManager
    {
        /// <summary>
        ...
        public static Hashtable LoadResources(string language)
        {
            ...
            string path = HttpContext.Current.Server.MapPath(GlobalConfig.LanguageCodesPath + language + ".xml");
            string key = "NSurvey:LangCodes:" + language;
