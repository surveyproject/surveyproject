    ...
    public partial class ResultsReport : System.Web.UI.Page
    {
        ...
        private void BindAnswerTable(AnswerData questionAnswers, PlaceHolder container, int sectionNumber)
        {
            ...
            foreach (AnswerData.AnswersRow answer in questionAnswers.Answers)
            {
                ...
                spotImage.ImageUrl = "~/nsurveyadmin/images/spot_on.gif";
                ...
                if (voterAnswer != null)
                {
                    ...
                    {
                        spotImage.ImageUrl = "~/nsurveyadmin/images/spot_text.gif";
                    ...
                    {
                        spotImage.ImageUrl = "~/nsurveyadmin/images/spot_file.gif";
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        spotImage.ImageUrl = "~/nsurveyadmin/images/spot_off.gif";
                    }
                }
