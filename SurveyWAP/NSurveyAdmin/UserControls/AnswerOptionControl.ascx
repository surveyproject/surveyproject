...
<fieldset>
    ...
    <ol>
        ...
        <li id="accLI" runat="server">
            ...
            <div id="tooltip">
                <asp:TextBox ID="AnswerCssClassTextBox" runat="server"></asp:TextBox></div>
        </li>
        ...
        <li id="saLI" runat="server">
            ...
            <div id="tooltip">
                <asp:CheckBox ID="SliderAnimateCheckbox" Visible="False" runat="server"></asp:CheckBox>
            </div>
        ...
        <asp:PlaceHolder ID="ConnectionsPlaceHolder" Visible="False" runat="server">
            <li>
                <div style="text-align: left;">
                    <asp:Label ID="ConnectionLabel" CssClass="scm" runat="server" Text="Connections :" EnableViewState="False"></asp:Label></div>
            </li>
            <li>
