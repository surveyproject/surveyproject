                    ...
                    <div class="loginBoxDiv">
                                <div title="Login Form" class="normal">
                                            ...
                                            <div class="validateButton">
                                                <asp:Button ID="ValidateCredentialsButton" ToolTip="Validate credentials" CssClass="btn btn-primary btn-sm bw" runat="server" Text="Validate credentials"></asp:Button>
                                            </div>
                                </div>                              
                </div>
