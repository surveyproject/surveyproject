    ...
    <ol>
        ...
        <li>
            ...
            <table style="width: 100%;">
                ...
                <tr>
                    <td style="width: 45%;">
                        <asp:ListBox ID="SurveysListBox" runat="server" AutoPostBack="True" Width="100%" Rows="6"></asp:ListBox>
                    </td>
                    <td class="smallText" style="width: 10%;">&nbsp;<strong>&gt;&gt;<br />
                        &lt;&lt;</strong>&nbsp;
                    </td>
                    <td style="width: 45%;">
                        <asp:ListBox ID="UserSurveysListBox" runat="server" AutoPostBack="True" Width="100%" Rows="6"></asp:ListBox>
                    </td>
                </tr>
            </table>
        ...
        <li>
            ...
            <table style="width: 100%;">
                ...
                <tr>
                    <td style="width: 45%;">
                        <asp:ListBox ID="RolesListBox" runat="server" AutoPostBack="True" Width="100%" Rows="6"></asp:ListBox>
                    </td>
                    <td class="smallText" style="width: 10%;">&nbsp;<strong>&gt;&gt;<br />
                        &lt;&lt;</strong>&nbsp;
                    </td>
                    <td style="width: 45%;">
                        <asp:ListBox ID="UserRolesListBox" runat="server" AutoPostBack="True" Width="100%" Rows="6"></asp:ListBox>
                    </td>
                </tr>
            </table>
        </li>
        <li>
            ...
            <asp:Button ID="ImportUsersButton" CssClass="btn btn-primary btn-xs bw" runat="server" Text="Import users" OnClick="ImportUsersButton_Click1"></asp:Button>
            <br />
            <br />
        </li>
    </ol>
