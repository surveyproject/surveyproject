    ...
    <table class="TableLayoutContainer">
      ...
      <tr>
        <td class="contentCell" valign="top">
            <br />
            <h2 style="color:#5720C6;">Installation Settings</h2><br />
            <br />
            <hr style="color:#E2E2E2;" />
            <br /> <br />
            Installation settings are at the core of the SP webapplication. They are set during the initial installation on the webserver and can be found
            in the web.config file in the root directory of the SP installation.
            <br /><br />
            Access to the Installation Settings webpage is restricted to SP administrators (admin account) only.

            <br /><br /><u>Encryption</u><br /><br />
            Through the Installation Settings page the particular web.config sections can be encrypted and decrypted. Encryption will make the 
            ...
            <br /><br />
            On installation and by default the Web.config file sections are not encypted. When section settings are changed through the Installation Settings page these will be encrypted automatically. To decrypt the section press the Decrypt button.
            <br /><br /><br />
            <b>Database Connections</b><br /><br />
            This section is used to create the connections to the SP database(s) where all surveys, questions/ answers, settings and surveysresults are stored.
            <br /><br />
            ...
            To explicitely pick a culture/ language, replace "auto" with "en-US" or "nl-NL" for example. Through the SP Multi Language settings culture and language will also be influenced.
            <br /><br /><br />
            <b>Web.Config Settings</b><br /><br />
            ...
            <br /><br />
            The mailserver is used to send mailmessage from the SP application. Several features make use of the mailserver. E.g. invitation messages or notification messages. 
            <br /><br />
