...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server"><div id="helpPanel"><div>
                ...
                <h2 style="color:#5720C6;">Field - Basic</h2>
<hr style="color:#e2e2e2;" />
This field answertype renders a textbox on the surveyform for the respondent to enter free text. By default there is no maximum length limit set.
                If the size of the field needs to be changed or any of its properties it is possible to create
                a new field type using the Answer Type Creator.
<br />
The default basic field has no additional client side validation check built in.
<br />
<br />
<u>Field Basic AnswerType Settings</u><br />
<br />
...
<hr style="color:#e2e2e2;" /> <h3>More Information</h3><br />
                ...
                <a href="new/Answer Type Creator.aspx" title=" Answer Type Creator " >Answer Type Creator </a>	<br />
