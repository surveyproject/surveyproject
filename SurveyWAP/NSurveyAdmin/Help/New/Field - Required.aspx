...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server"><div id="helpPanel"><div>
                ...
                <h2 style="color:#5720C6;">
                    Field - Required</h2><hr style="color:#e2e2e2;" />

This field answertype renders a basic textbox. There is no maximum length
limit by default. If changes are required to the size of the field or its
properties it is possible to create a custom field type using the Answer Type Creator.<br />
<br />
This field answertype has a client side validation script by default to check it has been
filled. It is recommended to also activate the server-side check using the Mandatory option as described below.<br />
<br />
<u>Field Required Answertype Settings</u><br />
<br />
