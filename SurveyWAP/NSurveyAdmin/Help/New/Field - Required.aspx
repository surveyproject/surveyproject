...
This type renders a standard textbox. There is no maximum length
limit by default. If changes are required of the size of the field or its
properties it is possible to create a custom field type using the Answer%20Type%20Creator.html.<br />
<br />
This field has a client side validation script to make sure it has been
filled. It is recommended to also activate the server-side check using
the Mandatory option as described below.<br />
<br />
