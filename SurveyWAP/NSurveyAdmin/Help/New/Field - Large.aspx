...
This type renders a large textbox that supports multiple lines of comment
from the respondent. It can be used to accept a large amount
of comments from respondents. There is no maximum length limit by
default. If the size of the field needs to be changed or any of its properties
it is possible to create a custom field type using the Answer%20Type%20Creator.html.<br />
<br />
The large field has no extra client side validation checks.<br />
<br />
...
<br />
<br />
* <i>Type</i><br />Option to change the current Answer type used in the survey. Respondent answers already collected will not be deleted if
