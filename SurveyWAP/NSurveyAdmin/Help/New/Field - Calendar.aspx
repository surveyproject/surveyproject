...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server"><div id="helpPanel"><div>
                ...
                <h2 style="color:#5720C6;">
                    Field - Calendar</h2><hr style="color:#e2e2e2;" />
             
This field answertype renders a default textbox on the surveyform showing a calendar to pick a date.<br />
<br />
As of SP v. 2.5 this answertype uses a (JQuery) client side validation script to check if the text entered is in a valid date format. The field
is not mandatory by default. It can be made mandatory by checking the mandatory option in the type settings.<br />
<br />
<u>Field Calendar AnswerType Settings</u><br />
<br />
