...
This type will render a rich textbox that supports bot Text and HTML editing by making use of the <a href="www.ckeditor.com" target="_blank">CKEditor</a>
component. There is no maximum length limit by default. If changes are required of the size of the field or
its properties it is possible to create our own field type using the answer%20Type%20Creator.html.<br />
<br />
...
<br />
* <i>TextBox Style</i> is the graphical template that will be used to show the
  HTML options of the textbox.<br />
<br />
* <i>Break Mode</i> is way line breaks are rendered in HTML inside the textbox.<br />
<br />
* <i>Language</i> is the language used to display the HTML options.<br />
<br />
* <i>ToolBar Layout</i> let us customize the toobar elements that the
