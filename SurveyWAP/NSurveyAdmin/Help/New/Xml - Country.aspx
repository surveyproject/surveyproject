...
This Answer type is bound to and will read the country xml file located in the
XmlData directory to show a list of countries. It is also possible to
create a new Xml bound type using the Answer%20Type%20Creator.html.<br />
<br />
If a default element should be selected in the dropdown list this can be done
by setting the &quot;Default Text Value&quot; property to a value that is available
inside the bound dropdownlist.<br />
<br />
Type Settings<br />
<br />
* Answer Text- the text that will be shown next to the dropdown list. <br />
<br />
* Image URL - option to add an image URL<br />
...
<br />
* Type - options to change the current type of the answer used in
  the survey. Respondent answers already collected will not be deleted if
  the type is changed.<br />
<br />
* Mandatory - option to set if the at least one answer from the dropdownlist is required. This check is done on the server-side.<br />
<br />
