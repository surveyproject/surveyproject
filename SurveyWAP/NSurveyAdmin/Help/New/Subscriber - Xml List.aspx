...
<br />
Out of the box a subscriber type can be used to be connected to an
...
the Xml - Country List, the Subscriber - Xml List type will receive US States
and try to load the us states .xml file.<br />
<br />
This type can subscribe to any publisher but its best to subscribe to XML Bound Asnwer Types- XMLT_Introduction.html. 
                <br />
<br />
