...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server"><div id="helpPanel"><div>
                ...
                <h2 style="color:#5720C6;">
                    Field - Email</h2><hr style="color:#e2e2e2;" />
           

This field answertype renders a standard textbox. There is no maximum length
limit by default. If changes are required to the size of the field or its
properties it is possible to create a custom field answertype using the
Answer Type Creator.<br />
<br />
This field has a client side validation script to make sure that a
correct email address has been provided. It is recommended to also activate the
Regular expression's email validation.<br />
<br />
<u>Field Email AnswerType Settings</u><br />
<br />
