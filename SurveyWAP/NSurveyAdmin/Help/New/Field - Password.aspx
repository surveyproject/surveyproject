...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server"><div id="helpPanel"><div>
                ...
                <h2 style="color:#5720C6;">
                    Field - Password</h2><hr style="color:#e2e2e2;" />
     
This field answerttype renders a password textbox on the surveyform from which text cannot be read in order to protect the password from 
                being visible to others.<br />
<br />
This field has no extra client side validation checks.<br />
<br />
<u>Field Password AnswerType Settings</u><br />
<br />
