...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server"><div id="helpPanel"><div>
                ...
                <h2 style="color:#5720C6;">
                    Field - Hidden</h2><hr style="color:#e2e2e2;" />
            
This field answertype type will not be visible to the respondent. The main purpose of this answertype 
                is to gather additional information without showing it on the surveyform.<br />
<br />
Example: in order to capture the browser used by the respondent a 'Field - Hidden' answertype could be added to the question and by setting the
default text to : <code>%%HTTP_USER_AGENT%%</code>  it would automatically capture the
browser of the respondent and add it to the answerresults. <br />
<br />
<u>Field Hidden AnswerType Settings</u><br />
<br />
